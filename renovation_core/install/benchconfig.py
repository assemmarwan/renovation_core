...
def update_supervisor():
  ...
  with open(supervisor_filepath, 'r+') as f:
    ...
    supervisor_config = supervisor_config.replace("frappe.app:application", "renovation_core.app:application")
    supervisor_config = supervisor_config.replace("apps/frappe/socketio.js", "apps/renovation_core/socketio.js")

    f.seek(0)
    f.write(supervisor_config)

  click.echo("Supervisor config file updated to use renovation_core.app.application and renovation_core/socketio.js")
...
def update_procfile():
  ...
  with open(procfile_path, 'r+') as f:
    ...
    proc = proc.replace("apps/frappe/socketio.js", "apps/renovation_core/socketio.js")
    f.seek(0)
    f.write(proc)
